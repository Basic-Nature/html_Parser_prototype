...
- source_sentence: Unknown Contest
  ...
  - REP Daniel W. SullivanRepublican - Absentee Mail
...
* Approximate statistics based on the first 498 samples:
  ...
  | details | <ul><li>min: 2 tokens</li><li>mean: 3.79 tokens</li><li>max: 9 tokens</li></ul> | <ul><li>min: 3 tokens</li><li>mean: 10.12 tokens</li><li>max: 16 tokens</li></ul> | <ul><li>min: 1.0</li><li>mean: 1.0</li><li>max: 1.0</li></ul> |
* Samples:
  | sentence_0                   | sentence_1                                         | label            |
  |:-----------------------------|:---------------------------------------------------|:-----------------|
  | <code>Unknown Contest</code> | <code>Totals - Total Vote</code>                   | <code>1.0</code> |
  | <code></code>                | <code>DEM Chrissy Knapp (Democratic) - Mail</code> | <code>1.0</code> |
