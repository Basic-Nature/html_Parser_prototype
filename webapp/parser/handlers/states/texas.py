...
Auto-generated handler for Texas election data extraction.
...
Generated with: python scripts/generate_state_handler.py Texas --simple
"""
from webapp.parser.handlers.shared.state_handler_base import SimpleTableHandler


class TexasHandler(SimpleTableHandler):
    """Handler for Texas election data."""
...
_handler_instance = TexasHandler()
