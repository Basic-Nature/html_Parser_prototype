...
Generated: 2026-03-06 02:31:50Z
Total annotations: 47
High: 2, Medium: 45, Low: 0
...
- L23 **FIXME**: | `FIXME` | Known bugs or issues to fix | `# FIXME: Race condition in auth` |
...
- L51 **FIXME**: # FIXME: Medium priority - Race condition on concurrent uploads
