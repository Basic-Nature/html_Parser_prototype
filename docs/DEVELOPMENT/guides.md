...
>
> - HANDLER_MIGRATION_GUIDE.md (historical source) - Handler development patterns
> - MODERN_UI_FEATURES.md (historical source) - Frontend features
...
See [System Architecture](../ARCHITECTURE/system_overview.md) for the complete architecture. Quick overview:
...
- [ ] Edge case testing
- [ ] Test coverage > 80%
- [ ] Required tests pass for the change

### Documentation

- [ ] Handler documented in [handlers.md](../ARCHITECTURE/parser_pipeline.md)
...
2. Required tests pass for the change
...
- HANDLER_MIGRATION_GUIDE.md (historical source)
- MODERN_UI_FEATURES.md (historical source)
