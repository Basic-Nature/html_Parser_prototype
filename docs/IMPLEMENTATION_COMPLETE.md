...
- Bundle CSS classes in `ballot_lens_modern.css`
...
**File:** `webapp/static/js/ballot_lens_modern.js` + `ballot_lens_modern.css`
...
**File:** `webapp/static/js/ballot_lens_modern.js` + `ballot_lens.html` + `ballot_lens_modern.css`
...
- [x] All code implemented in ballot_lens_modern.js
- [x] All CSS added to ballot_lens_modern.css
