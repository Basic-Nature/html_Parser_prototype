...
def _supports_alter_check_constraints() -> bool:
    """SQLite development/offline paths cannot ALTER existing check constraints."""
...
def upgrade() -> None:
    ...
    if _supports_alter_check_constraints():
